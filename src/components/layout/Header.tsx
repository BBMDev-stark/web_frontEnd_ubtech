      ...
      <header className={cn(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center h-16 gap-4">
          ...
          <Link href="/" className="flex-shrink-0 flex items-center group">
            ...
            <span style={{ display: 'none' }} className="items-center gap-2">
              <span className="w-9 h-9 rounded-xl bg-[#0057FF] flex items-center justify-center text-white font-black text-base">U</span>
              <span className="font-black text-[#0057FF] text-xl tracking-tight">
                UBTECH<span className="text-sm ml-0.5 text-[#0057FF]/70">VN</span>
              </span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-1.5 ml-auto">
            ...
            {user ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                <Link href="/dang-nhap"
                  className="text-sm font-semibold text-[#003DA5] px-4 py-2 rounded-xl hover:bg-[#EEF3FF] transition-colors">
                  Đăng nhập
                </Link>
                <Link href="/dang-ky"
                  className="text-sm font-semibold bg-[#0057FF] text-white px-4 py-2 rounded-xl hover:bg-[#003DA5] transition-colors shadow-sm shadow-blue-200">
                  Đăng ký
                </Link>
              </div>
            )}
        ...
        <div className="hidden lg:block border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center h-11">
            ...
            {/* ── 5. CTA Liên hệ nổi bật (cuối nav bar) ── */}
            <div className="ml-auto flex items-center gap-3">
              <a
                href={`tel:${PHONE}`}
                className="hidden xl:flex items-center gap-1.5 text-[13px] font-semibold text-[#003DA5] hover:text-[#0057FF] transition-colors"
              >
                <Phone className="w-3.5 h-3.5" />
                {PHONE}
              </a>
              <Link
                href="/lien-he"
                className="flex items-center gap-1.5 px-4 py-2 bg-[#0057FF] text-white text-[12px] font-bold rounded-xl hover:bg-[#003DA5] transition-all shadow-sm shadow-blue-200 hover:shadow-blue-300"
              >
              ...
              {!user && (
                <div className="flex gap-2 pt-1">
                  <Link
                    href="/dang-nhap"
                    onClick={() => setMobileOpen(false)}
                    className="flex-1 text-center text-sm font-semibold text-[#003DA5] px-4 py-2.5 rounded-xl border border-[#003DA5]/30 hover:bg-[#EEF3FF] transition-colors"
                  >
                    Đăng nhập
                  </Link>
                  <Link
                    href="/dang-ky"
                    onClick={() => setMobileOpen(false)}
                    className="flex-1 text-center text-sm font-semibold bg-[#0057FF] text-white px-4 py-2.5 rounded-xl hover:bg-[#003DA5] transition-colors"
                  >
                    Đăng ký
                  </Link>
                </div>
