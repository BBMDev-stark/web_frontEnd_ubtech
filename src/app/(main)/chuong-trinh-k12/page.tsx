...
export const metadata = {
  title: "Chương trình AI & Robotics K12 | UBTECH Việt Nam",
};
...
const PROGRAMS = [
  {
    ...
    image:
      "https://lh3.googleusercontent.com/d/1RTKSLUhDzH9H4xVNYUMkH2gZmRl9RnsU",
  ...
  },
  {
    ...
    skills: [
      "Nghiên cứu khoa học AI",
      "Dự án nông nghiệp/công nghiệp",
      "Tư duy phản biện",
      "Python & AI thuật toán",
    ],
      ...
      <section className="bg-gradient-to-br from-[#001F6B] to-[#0057FF] text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Chương trình học AI & Robotics hoàn chỉnh nhất tại Việt Nam — từ lớp
            1 đến lớp 12. Được Bộ GD&ĐT và Bộ KH&CN chứng nhận.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-black text-[#1A1F36]">
            Lộ trình học tập theo cấp độ
          </h2>
          <p className="text-[#6B7280] mt-3 max-w-2xl mx-auto">
            Mỗi cấp độ được thiết kế phù hợp với khả năng nhận thức và trình độ
            của học sinh, đảm bảo tính liên tục và logic trong quá trình học.
          </p>
        </div>
          ...
          {PROGRAMS.map((prog, idx) => (
            ...
            >
              <div className={idx % 2 === 1 ? "lg:col-start-2" : ""}>
                <div
                  className={`inline-block px-3 py-1.5 rounded-xl text-sm font-black text-white bg-gradient-to-r ${prog.color} mb-4 shadow-md`}
                >
                  {prog.level}
                </div>
                <h3 className="text-2xl font-black text-[#1A1F36] mb-3">
                  {prog.name}
                </h3>
                ...
                <div className="mb-6">
                  <p className="text-sm font-bold text-[#1A1F36] mb-3">
                    Kỹ năng phát triển:
                  </p>
                ...
                >
                  Xem sản phẩm: {prog.product}{" "}
                  <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
              <div className={idx % 2 === 1 ? "lg:col-start-1" : ""}>
                <div
                  className={`rounded-2xl border-2 ${prog.bgLight} p-6 flex items-center justify-center min-h-[280px]`}
                >
                  <img
                    src={prog.image}
                    alt={prog.name}
      ...
      <section className="bg-gradient-to-r from-[#003DA5] to-[#0057FF] py-14 text-center">
        <div className="max-w-xl mx-auto px-4">
          ...
          <p className="text-blue-200 mb-8">
            Chuyên gia UBTECH sẽ tư vấn chương trình học phù hợp nhất với nhu
            cầu của trường học và trung tâm của bạn.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/san-pham?category=bo-kit"
